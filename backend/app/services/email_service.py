        ...
        try:
            ...
            <head>
                <style>
                    ...
                    .accent {{ color: #f97316; }}
                    .content {{ padding: 24px; color: #e5e7eb; line-height: 1.6; }}
                    .message {{ background: #0b1220; border: 1px solid #334155; border-radius: 10px; padding: 14px; margin: 14px 0 18px; }}
                    .stats {{ display: grid; grid-template-columns: 1fr; gap: 10px; margin-top: 8px; }}
